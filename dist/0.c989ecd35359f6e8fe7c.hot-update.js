	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        cats.map(function (cat) {
	          return _react2['default'].createElement(_cat_index_item2['default'], { cat: cat, deleteCat: _this.props.deleteCat });
	        }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CatIndexItem = (function (_Component) {
	  _inherits(CatIndexItem, _Component);
	
	  function CatIndexItem() {
	    _classCallCheck(this, CatIndexItem);
	
	    _get(Object.getPrototypeOf(CatIndexItem.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(CatIndexItem, [{
	    key: 'render',
	    value: function render() {
	...
	exports['default'] = CatIndexItem;
	module.exports = exports['default'];

/***/ }

})
//# sourceMappingURL=0.c989ecd35359f6e8fe7c.hot-update.js.map